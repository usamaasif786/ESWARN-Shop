    ...
    <div className="collapse navbar-collapse" id="navbarNavDropdown">
      <ul className="navbar-nav d-flex align-items-center">
        ...
        <Link  className="nav-link " to="/contact">Contact</Link>
          {/* <Link className="nav-link" href="#">CONTACT</a> */}
        </li>
        <li className="nav-item dropdown mr">
          <a className="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"> CATEGORY </a>
