  ...
  return(
    <>
      <div className='row d-flex justify-content-center mt-4'>
        ...
        <div className='col-6'>
          <input type="text" className="form-control" id="exampleInputEmail1" placeholder="Product name / title"/>
          <select class="form-control mt-4">
            <option>Category</option>
            <option>Others</option>
          </select>
          <input type="email" className="form-control mt-4" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Product info"/>
          ...
          <input type="email" className="form-control mt-4" id="exampleInputEmail1" placeholder="Heading 2"/>
          <input type="email" className="form-control mt-4 mb-4" id="exampleInputEmail1" placeholder="Info"/> 
          <div className='row d-flex justify-content-between mt-4 mb-4'>
            <div class="col-5  form-check form-check-inline">
              <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1"/>
              <label class="form-check-label" for="inlineCheckbox1">Add to front page as new product</label>
            </div>
            <div class="col-5 form-check form-check-inline">
              <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1"/>
              <label class="form-check-label" for="inlineCheckbox1">Add to front page as top seller</label>
            </div>    
          </div>
